...
LOG_FILE_PATH = os.path.join(LOGS_DIR, "galCMD.txt")
...
def ui_banner():
    ...
    print(f"  ╔══════════════════════════════════════════════════════╗")
    print(f"  ║         🎨  galCMD - Civitai Model Downloader        ║")
    print(f"  ╚══════════════════════════════════════════════════════╝")
    print(f"{Style.RESET}")
...
parser = argparse.ArgumentParser(description="galCMD - Civitai Model Downloader: download model files and images from the Civitai API.")
